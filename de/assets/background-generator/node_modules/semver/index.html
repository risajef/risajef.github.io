...
<head>
    ...
    <meta property="og:type"
        content="website">
    <meta property="og:url" content="/de/assets/background-generator/node_modules/semver/">
    <meta property="og:site_name" content="Reto Weber">
    <meta property="og:image" content="/output.png">

    <!-- Twitter Card -->
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="semver(1) -- The semantic versioner for npm">
    ...
    <script type="application/ld+json">
    {
      ...
      "mainEntityOfPage": {
        "@type": "WebPage",
        "@id": "/de/assets/background-generator/node_modules/semver/"
      },
      "headline": "semver(1) -- The semantic versioner for npm",
    ...
    <title>semver(1) -- The semantic versioner for npm - Reto Weber</title>
...
<body>
    ...
    <header class="site-header">
        ...
        <nav class="language-switcher" aria-label="Language selector">
            ...
            <a href="../../../../../assets/background-generator/node_modules/semver/" class="active">English</a>
...
<pre><code class="language-js">// load the whole API at once in a single object
const semver = require('semver')
...
<pre><code class="language-bash">$ semver 1.2.4-beta.1 -i release
1.2.4
</code></pre>
...
<pre><code class="language-javascript">semver.inc('1.2.3', 'prerelease', 'beta', '1')
// '1.2.4-beta.1'
</code></pre>
<pre><code class="language-javascript">semver.inc('1.2.3', 'prerelease', 'beta', false)
// '1.2.4-beta'
</code></pre>
<p>command-line example:</p>
<pre><code class="language-bash">$ semver 1.2.3 -i prerelease --preid beta -n 1
1.2.4-beta.1
</code></pre>
<pre><code class="language-bash">$ semver 1.2.3 -i prerelease --preid beta -n false
1.2.4-beta
</code></pre>
...
<pre><code>const semver = require('semver');
