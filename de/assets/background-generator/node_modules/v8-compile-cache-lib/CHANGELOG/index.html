...
<head>
    ...
    <meta property="og:title" content="v8-module-cache Changelog">
    <meta property="og:description"
        content="Reto Weber - programming, research, politics, books, religion, philosophy and science. []">
    <meta property="og:type"
        content="website">
    <meta property="og:url" content="/de/assets/background-generator/node_modules/v8-compile-cache-lib/CHANGELOG/">
    <meta property="og:site_name" content="Reto Weber">
    <meta property="og:image" content="/output.png">

    <!-- Twitter Card -->
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="v8-module-cache Changelog">
    ...
    <script type="application/ld+json">
    {
      ...
      "mainEntityOfPage": {
        "@type": "WebPage",
        "@id": "/de/assets/background-generator/node_modules/v8-compile-cache-lib/CHANGELOG/"
      },
      "headline": "v8-module-cache Changelog",
    ...
    <title>v8-module-cache Changelog - Reto Weber</title>
...
<body>
    ...
    <header class="site-header">
        ...
        <nav class="language-switcher" aria-label="Language selector">
            ...
            <a href="../../../../../../assets/background-generator/node_modules/v8-compile-cache-lib/CHANGELOG/" class="active">English</a>
    ...
    <div id="main-container">
        ...
        <div class="content">
            ...
            <h1 id="v8-module-cache-changelog"><code>v8-module-cache</code> Changelog</h1>
<h2 id="2021-03-05-version-230">2021-03-05, Version 2.3.0</h2>
<ul>
<li>Fix use require.main instead of module.parent <a href="https://github.com/zertosh/v8-compile-cache/pull/34">#34</a>.</li>
</ul>
<h2 id="2020-10-28-version-220">2020-10-28, Version 2.2.0</h2>
<ul>
<li>Added <code>V8_COMPILE_CACHE_CACHE_DIR</code> option <a href="https://github.com/zertosh/v8-compile-cache/pull/23">#23</a>.</li>
</ul>
<h2 id="2020-05-30-version-211">2020-05-30, Version 2.1.1</h2>
<ul>
<li>Stop using process.umask() <a href="https://github.com/zertosh/v8-compile-cache/pull/28">#28</a>.</li>
</ul>
<h2 id="2019-08-04-version-210">2019-08-04, Version 2.1.0</h2>
<ul>
<li>Fix Electron by calling the module wrapper with <code>Buffer</code> <a href="https://github.com/zertosh/v8-compile-cache/pull/10">#10</a>.</li>
</ul>
<h2 id="2019-05-10-version-203">2019-05-10, Version 2.0.3</h2>
<ul>
<li>Add <code>LICENSE</code> file <a href="https://github.com/zertosh/v8-compile-cache/pull/19">#19</a>.</li>
<li>Add "repository" to <code>package.json</code> (see <a href="https://github.com/zertosh/v8-compile-cache/commit/eea336eaa8360f9ded9342b8aa928e56ac6a7529">eea336e</a>).</li>
<li>Support <code>require.resolve.paths</code> (added in Node v8.9.0) <a href="https://github.com/zertosh/v8-compile-cache/pull/20">#20</a>/<a href="https://github.com/zertosh/v8-compile-cache/pull/22">#22</a>.</li>
</ul>
<h2 id="2018-08-06-version-202">2018-08-06, Version 2.0.2</h2>
<ul>
<li>Re-publish.</li>
</ul>
<h2 id="2018-08-06-version-201">2018-08-06, Version 2.0.1</h2>
<ul>
<li>Support <code>require.resolve</code> options (added in Node v8.9.0).</li>
</ul>
<h2 id="2018-04-30-version-200">2018-04-30, Version 2.0.0</h2>
<ul>
<li>Use <code>Buffer.alloc</code> instead of <code>new Buffer()</code>.</li>
<li>Drop support for Node 5.x.</li>
</ul>
<h2 id="2018-01-23-version-112">2018-01-23, Version 1.1.2</h2>
<ul>
<li>Instead of checking for <code>process.versions.v8</code>, check that <code>script.cachedDataProduced</code> is <code>true</code> (rather than <code>null</code>/<code>undefined</code>) for support to be considered existent.</li>
</ul>
<h2 id="2018-01-23-version-111">2018-01-23, Version 1.1.1</h2>
<ul>
<li>Check for the existence of <code>process.versions.v8</code> before attaching hook (see <a href="https://github.com/zertosh/v8-compile-cache/commit/f8b038848be94bc2c905880dd50447c73393f364">f8b0388</a>).</li>
</ul>
<h2 id="2017-03-27-version-110">2017-03-27, Version 1.1.0</h2>
<ul>
<li>Safer cache directory creation (see <a href="https://github.com/zertosh/v8-compile-cache/commit/bcb3b12c819ab0927ec4408e70f612a6d50a9617">bcb3b12</a>).</li>
<li>The cache is now suffixed with the user's uid on POSIX systems (i.e. <code>/path/to/tmp/v8-compile-cache-1234</code>).</li>
</ul>
<h2 id="2017-02-21-version-100">2017-02-21, Version 1.0.0</h2>
<ul>
