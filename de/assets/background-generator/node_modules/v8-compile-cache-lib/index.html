...
<head>
    ...
    <meta property="og:title" content="v8-compile-cache-lib">
    <meta property="og:description"
        content="Reto Weber - programming, research, politics, books, religion, philosophy and science. []">
    <meta property="og:type"
        content="website">
    <meta property="og:url" content="/de/assets/background-generator/node_modules/v8-compile-cache-lib/">
    <meta property="og:site_name" content="Reto Weber">
    <meta property="og:image" content="/output.png">

    <!-- Twitter Card -->
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="v8-compile-cache-lib">
    ...
    <script type="application/ld+json">
    {
      ...
      "mainEntityOfPage": {
        "@type": "WebPage",
        "@id": "/de/assets/background-generator/node_modules/v8-compile-cache-lib/"
      },
      "headline": "v8-compile-cache-lib",
    ...
    <title>v8-compile-cache-lib - Reto Weber</title>
...
<body>
    ...
    <header class="site-header">
        ...
        <nav class="language-switcher" aria-label="Language selector">
            ...
            <a href="../../../../../assets/background-generator/node_modules/v8-compile-cache-lib/" class="active">English</a>
    ...
    <div id="main-container">
        ...
        <div class="content">
            ...
            <h1 id="v8-compile-cache-lib">v8-compile-cache-lib</h1>
<blockquote>
<p>Fork of <a href="https://www.npmjs.com/package/v8-compile-cache"><code>v8-compile-cache</code></a> exposed as an API for programmatic usage in other libraries and tools.</p>
</blockquote>
<hr />
<p><a href="https://github.com/cspotcode/v8-compile-cache-lib/actions?query=workflow%3A%22Continuous+Integration%22"><img alt="Build status" src="https://img.shields.io/github/workflow/status/cspotcode/v8-compile-cache-lib/Continuous%20Integration" /></a></p>
<p><code>v8-compile-cache-lib</code> attaches a <code>require</code> hook to use <a href="https://v8project.blogspot.com/2015/07/code-caching.html">V8's code cache</a> to speed up instantiation time. The "code cache" is the work of parsing and compiling done by V8.</p>
<p>The ability to tap into V8 to produce/consume this cache was introduced in <a href="https://nodejs.org/en/blog/release/v5.7.0/">Node v5.7.0</a>.</p>
<h2 id="usage">Usage</h2>
<ol>
<li>Add the dependency:</li>
</ol>
<p><code>sh
  $ npm install --save v8-compile-cache-lib</code></p>
<ol>
<li>Then, in your entry module add:</li>
</ol>
<p><code>js
  require('v8-compile-cache-lib').install();</code></p>
<p><strong><code>.install()</code> in Node &lt;5.7.0 is a noop – but you need at least Node 4.0.0 to support the ES2015 syntax used by <code>v8-compile-cache-lib</code>.</strong></p>
<h2 id="options">Options</h2>
<p>Set the environment variable <code>DISABLE_V8_COMPILE_CACHE=1</code> to disable the cache.</p>
<p>Cache directory is defined by environment variable <code>V8_COMPILE_CACHE_CACHE_DIR</code> or defaults to <code>&lt;os.tmpdir()&gt;/v8-compile-cache-&lt;V8_VERSION&gt;</code>.</p>
<h2 id="internals">Internals</h2>
<p>Cache files are suffixed <code>.BLOB</code> and <code>.MAP</code> corresponding to the entry module that required <code>v8-compile-cache-lib</code>. The cache is <em>entry module specific</em> because it is faster to load the entire code cache into memory at once, than it is to read it from disk on a file-by-file basis.</p>
...
<ul>
<li>The original <a href="https://github.com/zertosh/v8-compile-cache"><code>v8-compile-cache</code></a> from which this library is forked.</li>
<li><code>FileSystemBlobStore</code> and <code>NativeCompileCache</code> are based on Atom's implementation of their v8 compile cache: </li>
...
<li><code>mkdirpSync</code> is based on:</li>
