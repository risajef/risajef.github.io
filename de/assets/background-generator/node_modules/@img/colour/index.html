...
<head>
    ...
    <meta property="og:title" content="@img/colour">
    <meta property="og:description"
        content="Reto Weber - programming, research, politics, books, religion, philosophy and science. []">
    <meta property="og:type"
        content="website">
    <meta property="og:url" content="/de/assets/background-generator/node_modules/%40img/colour/">
    <meta property="og:site_name" content="Reto Weber">
    <meta property="og:image" content="/output.png">

    <!-- Twitter Card -->
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="@img/colour">
    ...
    <script type="application/ld+json">
    {
      ...
      "mainEntityOfPage": {
        "@type": "WebPage",
        "@id": "/de/assets/background-generator/node_modules/%40img/colour/"
      },
      "headline": "@img/colour",
    ...
    <title>@img/colour - Reto Weber</title>
...
<body>
    ...
    <header class="site-header">
        ...
        <nav class="language-switcher" aria-label="Language selector">
            ...
            <a href="../../../../../../assets/background-generator/node_modules/%40img/colour/" class="active">English</a>
    ...
    <div id="main-container">
        ...
        <div class="content">
            ...
            <h1 id="imgcolour"><code>@img/colour</code></h1>
...
which includes versions of Node.js prior to 20.19.0.</p>
<p>This package converts the <code>color</code> package and its dependencies,
all of which are MIT-licensed, to CommonJS.</p>
<ul>
<li><a href="https://www.npmjs.com/package/color">color</a></li>
<li><a href="https://www.npmjs.com/package/color-convert">color-convert</a></li>
<li><a href="https://www.npmjs.com/package/color-string">color-string</a></li>
<li><a href="https://www.npmjs.com/package/color-name">color-name</a></li>
</ul>
        </div>
    </div>
