...
<head>
    ...
    <meta property="og:title" content="create-require">
    <meta property="og:description"
        content="Reto Weber - programming, research, politics, books, religion, philosophy and science. []">
    <meta property="og:type"
        content="website">
    <meta property="og:url" content="/de/assets/background-generator/node_modules/create-require/">
    <meta property="og:site_name" content="Reto Weber">
    <meta property="og:image" content="/output.png">

    <!-- Twitter Card -->
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="create-require">
    ...
    <script type="application/ld+json">
    {
      ...
      "mainEntityOfPage": {
        "@type": "WebPage",
        "@id": "/de/assets/background-generator/node_modules/create-require/"
      },
      "headline": "create-require",
    ...
    <title>create-require - Reto Weber</title>
...
<body>
    ...
    <header class="site-header">
        ...
        <nav class="language-switcher" aria-label="Language selector">
            ...
            <a href="../../../../../assets/background-generator/node_modules/create-require/" class="active">English</a>
    ...
    <div id="main-container">
        ...
        <div class="content">
            ...
            <h1 id="create-require"><code>create-require</code></h1>
<p><a href="https://npmjs.com/package/create-require"><img alt="npm version" src="https://img.shields.io/npm/v/create-require?style=flat-square" /></a>
<a href="https://npmjs.com/package/create-require"><img alt="npm downloads" src="https://img.shields.io/npm/dm/create-require?style=flat-square" /></a>
<a href="https://github.com/nuxt-contrib/create-require/actions?query=workflow%3Atest"><img alt="Github Actions" src="https://img.shields.io/github/workflow/status/nuxt-contrib/create-require/test/master?style=flat-square" /></a>
<a href="https://codecov.io/gh/nuxt-contrib/create-require"><img alt="Codecov" src="https://img.shields.io/codecov/c/gh/nuxt-contrib/create-require/master?style=flat-square" /></a></p>
<p>Polyfill for Node.js <a href="https://nodejs.org/api/modules.html#modules_module_createrequire_filename"><code>module.createRequire</code></a> (&lt;= v12.2.0)</p>
<h2 id="install">Install</h2>
<pre><code class="language-sh">yarn add create-require

npm install create-require
</code></pre>
<h2 id="usage">Usage</h2>
<pre><code class="language-ts">function createRequire (filename: string | URL): NodeRequire;
</code></pre>
<pre><code class="language-js">const createRequire = require('create-require')

const myRequire = createRequire('path/to/test.js')
const myModule = myRequire('./test-sibling-module')
</code></pre>
<h2 id="license">License</h2>
<p><a href="../../../../../assets/background-generator/node_modules/create-require/LICENSE">MIT</a></p>
<!-- Badges -->
        </div>
    </div>
