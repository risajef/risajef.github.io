...
<head>
    ...
    <meta property="og:title" content="make-error">
    <meta property="og:description"
        content="Reto Weber - programming, research, politics, books, religion, philosophy and science. []">
    <meta property="og:type"
        content="website">
    <meta property="og:url" content="/assets/background-generator/node_modules/make-error/">
    <meta property="og:site_name" content="Reto Weber">
    <meta property="og:image" content="/output.png">

    <!-- Twitter Card -->
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="make-error">
    ...
    <script type="application/ld+json">
    {
      ...
      "mainEntityOfPage": {
        "@type": "WebPage",
        "@id": "/assets/background-generator/node_modules/make-error/"
      },
      "headline": "make-error",
    ...
    <title>make-error - Reto Weber</title>
...
<body>
    ...
    <header class="site-header">
        ...
        <nav class="language-switcher" aria-label="Language selector">
            ...
            <a href="../../../../de/assets/background-generator/node_modules/make-error/" class="">Deutsch</a>
    ...
    <div id="main-container">
        ...
        <div class="content">
            ...
            <h1 id="make-error">make-error</h1>
<p><a href="https://npmjs.org/package/make-error"><img alt="Package Version" src="https://badgen.net/npm/v/make-error" /></a> <a href="https://travis-ci.org/JsCommunity/make-error"><img alt="Build Status" src="https://travis-ci.org/JsCommunity/make-error.png?branch=master" /></a> <a href="https://packagephobia.now.sh/result?p=make-error"><img alt="PackagePhobia" src="https://badgen.net/packagephobia/install/make-error" /></a> <a href="https://github.com/JsCommunity/make-error/commits/master"><img alt="Latest Commit" src="https://badgen.net/github/last-commit/JsCommunity/make-error" /></a></p>
<blockquote>
...
<h3 id="node-browserifywebpack">Node &amp; <a href="http://browserify.org/">Browserify</a>/<a href="https://webpack.js.org/">Webpack</a></h3>
...
<h3 id="basic-named-error">Basic named error</h3>
<pre><code class="language-javascript">var CustomError = makeError(&quot;CustomError&quot;);

// Parameters are forwarded to the super class (here Error).
throw new CustomError(&quot;a message&quot;);
</code></pre>
<h3 id="advanced-error-class">Advanced error class</h3>
...
<h3 id="specialized-error">Specialized error</h3>
