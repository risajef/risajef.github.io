...
![Unkomprimiert](/Bewertungen/Bilder/weight uncompressed.png)
*Random unkomprimierte Gewichtsschicht*

![JPEG komprimiert 20% Qualität](/Bewertungen/Bilder/weight compressed.png)
...
- Die Wahl einer anderen Grundlage für die Gewichte, wie die Fourier-Basis, statt ein unabhängiges Gewicht an jeder Position, könnte die Schaffung von großen Netzwerken mit einer begrenzten Anzahl von Gewichten ermöglichen.
- Diese Methode könnte auch in tiefen neuronalen Netzwerken arbeiten.
- Die Entwicklung einer differenzierbaren Methode, die erhebliche Komplexität mit wenigen Parametern erzeugt, könnte die Rechenfähigkeit der vorhandenen Hardware verbessern.
